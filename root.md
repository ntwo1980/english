...
1. am(at) = to love 爱
   ...
   1. **amiable** [am = to love 爱; -i-; -able *a*. = capable of 可...的 -> 可爱的 ->] *a.* 可爱的; 和蔼的
       * **unamiable** *a.* 不和蔼的; 不友好的
       * **enemy** *n.* 敌人[en-表示相反; em是am的变体]
   1. **amateur** [amat = to love 爱; -eur(-er) *n*. = person 人 -> 因爱好(而不是金钱)从事某项活动者 ->] *n.* (艺术、体育、科学等)业余爱好者
       * **amateurism** *n.* 业余活动
       * **amateurish** *a.* 不老练的
   1. **amicable** [amic (来自同根名词amicus) = person one loves, or friend 亲爱者,朋友; -able *a*. = able to be 能当...的 -> 能做朋友的 ->] *a.* 友好的; 和睦的
       * **amity** *a.* 友好; 和睦
       * **amicability** *n.* 友好; 和睦
   1. **amour** [am = to love 爱; -our *n*. = the state or result of 表状态或结果 -> 恋爱或恋爱的结果 ->] *n.* (1) 恋爱 (2) 不正当的男女关系, 桃色事件
       * **amorous** *a.* 恋爱的; 多情的
       * **amorist** *n.* 爱情小说作者; 好色之徒
       * **inamorata** *n.* [意] 女爱人; 女情人, 情妇
       * **inamorato** *n.* [意] 男爱人; 男情人
...
1. arch = rule 统治
   ...
   1. **anarchy** [an- (a-) = without 无; arch = rule 治理 -> -y *n.* = state 表状态 -> 缺乏治理的状态 ->] *n.* 无秩序; 无政府状态
       * **anarchic** *a.* 无政府主义的
       * **anarchism** *n.* 无政府主义
       * **anarchist** *n.* 无政府主义者
   1. **monarch** [mon- = one, alone 单一; arch = ruler 统治者 -> 单独治理国家者 ->] *n.* 国家; 君主
